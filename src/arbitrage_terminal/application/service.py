...
class TerminalService:
    def __init__(self,repo,scanner,ai,settings,exchanges=None):self.repo=repo;self.scanner=scanner;self.ai=ai;self.settings=settings;self.exchanges=exchanges if exchanges is not None else getattr(scanner,'exchanges',{})

...
PUBLIC_COMMANDS = [BotCommand('start', 'Start the Arbitrage Terminal'), BotCommand('dashboard', 'Open the main dashboard'), BotCommand('scan', 'Scan for arbitrage opportunities'), BotCommand('results', 'View scan history and results'), BotCommand('exchanges', 'Select exchanges'), BotCommand('filters', 'View and edit scan filters'), BotCommand('setfilter', 'Change a scan filter'), BotCommand('resetfilters', 'Reset filters to defaults'), BotCommand('settings', 'Validation and AI settings'), BotCommand('status', 'Exchange and runtime status'), BotCommand('diagnostics', 'View latest scan diagnostics'), BotCommand('ai', 'Configure AI result mode'), BotCommand('vipkey', 'Activate VIP access'), BotCommand('help', 'Show help and commands')]
